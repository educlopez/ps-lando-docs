...
Desde **1.0.0** (`1.0.0-rc.2`), `ps-lando` es **zero-config y theme-agnostic**: suelta tus zips de tema + módulos en una carpeta, ejecuta `ps-lando create` y la CLI te guía por dos prompts:
