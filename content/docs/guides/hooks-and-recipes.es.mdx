...
Cada script recibe este bundle canónico:
...
Cualquier `*.sh` ejecutable en `init-scripts/` o `post-scripts/` se recoge automáticamente. Ejemplo — seedear un grupo de empleados personalizado:
