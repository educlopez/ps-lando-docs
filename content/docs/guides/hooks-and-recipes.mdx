...
Every script receives this canonical bundle:
...
Any executable `*.sh` in `init-scripts/` or `post-scripts/` is automatically picked up. Example — seed a custom employee group:
